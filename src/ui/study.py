...
class StudyMode:
    ...
    def _show_phase_review(self):
        ...
        create_accent_button(lc, text="⚡ Sayfayı Puanla", command=self._score_current_view).pack(
            fill="x", pady=(0, Style.PADDING_SM))

        create_secondary_button(lc, text="🔄 Tüm Hastaları Tara", command=self._batch_scan_all).pack(
            fill="x", pady=(0, Style.PADDING_SM))
